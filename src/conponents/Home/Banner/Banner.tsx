      ...
      <div className="flex-1 w-full lg:w-1/2 space-y-8 z-10">
        ...
        <div className="flex flex-wrap gap-4 items-center pt-4">
          ...
          <Btn
            ...
            btn="Download Resume"
            value=""
            className=" group relative bg-gradient-to-r from-yellow-600 to-yellow-700  hover:from-yellow-700 hover:to-yellow-800  text-white font-semibold  px-8 py-4 rounded-xl shadow-lg hover:shadow-2xl hover:shadow-yellow-500/50 transition-all duration-300 ease-in-out  min-w-[180px] text-center overflow-hidden before:absolute before:inset-0 before:bg-white/20 before:translate-y-full hover:before:translate-y-0 before:transition-transform before:duration-300 "
